 ...
 * @description 读取指定文件下的所有文件及其子文件夹，根据文件类型进行过滤
*/
public class FilesAndFilessons {
    private List<File> list;
    private String basePath = "D:\\code\\";
    private String type = "jar";
    private Logger logger = LoggerFactory.getLogger(FilesAndFilessons.class);

    public static void main(String[] args) {
        new FilesAndFilessons().getList("");
        new FilesAndFilessons().getListByType("D:\\code\\", "java");
        new FilesAndFilessons().getListByType("D:\\code\\", "json");
        new FilesAndFilessons().getListByType("D:\\code\\", "xml");
    }
